...
c2 = x(17)*0.82*Utils.sound_speed(x(18)*10058.4) - 0.86*Utils.sound_speed(10058.4); %VMO, M bounds need to be changed 
c3 = (W_wing + W_AW + W_fuel)/I.Wing(1).Area - 217000/363.1; %Wing Loading
c4 = W_fuel/817.15 - Utils.tank_volume(I, Res_aero)*0.93;
c = [c1,c2];
ceq = [cc1,cc2];
end