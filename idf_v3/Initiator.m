...
W_AW = 93000; % A-W, defined as MTOW_ref - Wstr_init - Wfuel_init

I.Weight.MTOW = W_str + W_AW + W_fuel;
I.Weight.ZFW = W_str + W_AW;
I.Weight.Design = sqrt((W_str + W_AW + W_fuel)*(W_str + W_AW));
% I.Weight.MTOW = 210000;
% I.Weight.ZFW = 131000;
% I.Weight.Design = sqrt(210000*131000);
I.n_max = 2.5;
...
I.Wing(1).Area = (c_r+c_k)*0.2*span/2+(c_k+c_r*taper)*(1-0.2)*span/2; %area of the wh
I.Wing(1).Span = span;
I.Wing(1).SectionNumber = 3;
I.Wing(1).AirfoilNumber = 3;

I.Wing(1).AirfoilName = "airfoil_ref";
